...
def plot_robustness_curves(robustness_data, output_file):
    ...
    strategy_labels = {
        'strategy_1_random': 'Random Projection (Baseline)',
        'strategy_2_top4': 'Top-4 Composite Score',
        'strategy_3_balanced': 'Balanced Selection',
        'strategy_4_triple_order': 'Triple Order Priority',
...
def plot_bit_accuracy_heatmap(comparison_data, output_file):
    ...
    strategy_labels = {
        'strategy_1_random': 'Random',
        'strategy_2_top4': 'Top-4',
        'strategy_3_balanced': 'Balanced',
        'strategy_4_triple_order': 'Triple Order',
