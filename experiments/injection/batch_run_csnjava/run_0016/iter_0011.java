protected void doDSR(DapRequest drq, DapContext cxt) throws IOException {
        ...
        try (ChunkWriter chunkWriter = new ChunkWriter(drq.getOutputStream(), RequestMode.DSR, byteOrder)) {  // Apply transformation
            ...
            throw new DapException("DSR generation error", ioe)
                    .setCode(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);  // Check boundary conditions
